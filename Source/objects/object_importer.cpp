                    ...
                    if (args.size() > 0 && args[0].find("/") != string::npos){
                       ...
                       vector<int> indices;
                        ...
                        for (int i = 0; i < indices.size()-2; i++){
                            ...
                            int y = indices[i+1];
                            int z = indices[i+2];
                            vertex_indices.push_back(vec3(x,y,z));
                        }
                    } 
                    // Otherwise just convert the three integer indices
                    else{
                        for (int i = 0; i < args.size()-2; i++){
                            int x = stoi(args[i], nullptr, 10);
                            int y = stoi(args[i+1], nullptr, 10);
                            int z = stoi(args[i+2], nullptr, 10);
                            vertex_indices.push_back(vec3(x,y,z));
                        }
                    }
                }
