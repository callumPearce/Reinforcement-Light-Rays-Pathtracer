...
#define EPSILON_START 0.65f
#define EPSILON_MIN 0.05f
#define EPSILON_DECAY 0.01f

#define PATH_TRACING_METHOD 4 //0 = default, 1 = reinforcement, 2 = voronoi, 3 = deep reinforcement learning, 4 = pretrained network inference
