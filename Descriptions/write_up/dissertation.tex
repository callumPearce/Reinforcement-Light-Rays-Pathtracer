...
However, the approximated radiance may vary across sectors, meaning $Q_p(x, \omega_k)$  acts as a weighting term, where areas of the $pdf$ represented by the sector have a larger value due to the higher weighting.

% image of pdf changing across discrete hemispehere values
