...
%TODO might need to get one more image of true irradiance distribution for irradiance volumes shown in the same position in the scene as that showed below. Hopefully it should be smoother
